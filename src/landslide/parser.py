...
class Parser(object):
    ...
    RST_REPLACEMENTS = [
	    ...
	    # For removing hyperlings tags generated by RST parser when
	    # including TOC using .. contents::
            (r'<a class="reference internal".*>(.*)</a>', r'\1', re.UNICODE),
            (r'<a class="toc-backref".*>(.*)</a>', r'\1', re.UNICODE),
    ]
    md_extensions = ''
